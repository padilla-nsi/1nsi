...
1. **Interface** - [HTML et CSS](../cours/interface/html_css/10_html_et_css.ipynb) et voici <a href="../cours/interface/html_css/Chapitre 1 - HTML et CSS.ipynb">lien</a>  (#html-et-css)
...
> **Histoire** <br>
Événements clés et protagonistes de l’histoire de l’informatique.
> * ???

> **Langages** <br> Constructions élémentaires
...
> **Types de base** <br> Valeurs booléennes : 0,1.
...
>**Types de base** <br> Représentation
...
>**Types de base** <br> Représentation d’un texte en machine.
...
>**Types construits** <br> Tableau indexé, tableau donné en compréhension.
...
> **Algo** <br>  Parcours séquentiel d’un tableau
...
>**Algo** <br> Tris par insertion, par sélection.
...
>**Algo** <br> Recherche dichotomique dans un tableau trié.
...
> **Types construits** <br> Dictionnaires par clés et valeurs
...
>**Données** <br> Indexation de tables
...
> **Données** <br> Recherche dans une table
...
>**Algo** <br> Algorithme des k plus proches voisins.
...
<br> Distinguer les transmissions de paramètres par les requêtes `POST` ou `GET`.
