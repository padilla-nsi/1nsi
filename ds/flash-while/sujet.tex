...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/pdf_solution/papier_eleve_ico_ds}}\fancyhead[C]{\bfseries\MakeUppercase{sujet}}\fancyhead[C]{\bfseries\MakeUppercase{Contrôle flash}}\fancyhead[R]{\monthyeardate\today}
...
% \maketitle
    ...
    \hypertarget{contruxf4le-flash}{%
\section{Contrôle flash}\label{contruxf4le-flash}}

    \hypertarget{exercice-1}{%
\paragraph{Exercice 1}\label{exercice-1}}

Écrire une fonction \texttt{digramme(a,\ b,\ tab)} qui teste s'il existe
dans le tableau \texttt{tab} une occurence de l'élément \texttt{a}
immédiatement suivie d'une occurence de l'élément \texttt{b}.

Tests et exemples :

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}}\NormalTok{ tab }\OperatorTok{=}\NormalTok{ [}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{9}\NormalTok{]}
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}} \BuiltInTok{print}\NormalTok{(digramme(}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, tab))}
\VariableTok{True}
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}} \BuiltInTok{print}\NormalTok{(digramme(}\DecValTok{4}\NormalTok{, }\DecValTok{2}\NormalTok{, tab))}
\VariableTok{False}
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}} \BuiltInTok{print}\NormalTok{(digramme(}\DecValTok{5}\NormalTok{, }\DecValTok{9}\NormalTok{, tab))}
\VariableTok{True}
\end{Highlighting}
\end{Shaded}
...
Écrire une fonction \texttt{pgs(elem,\ tab)} qui renvoie la longueur de
la plus grande séquence d'occurences consécutives de l'élément
\texttt{elem} dans le tableau \texttt{tab}.

Tests et exemples :

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}}\NormalTok{ tab }\OperatorTok{=}\NormalTok{ [}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{9}\NormalTok{, }\DecValTok{9}\NormalTok{]}
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}} \BuiltInTok{print}\NormalTok{(pgs(}\DecValTok{1}\NormalTok{, tab))}
\DecValTok{4}
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}} \BuiltInTok{print}\NormalTok{(pgs(}\DecValTok{2}\NormalTok{, tab))}
\DecValTok{0}
\OperatorTok{\textgreater{}\textgreater{}\textgreater{}} \BuiltInTok{print}\NormalTok{(pgs(}\DecValTok{9}\NormalTok{, tab))}
\DecValTok{2}
\end{Highlighting}
\end{Shaded}

    \hypertarget{exercice-1-bis}{%
\paragraph{Exercice 1 (bis)}\label{exercice-1-bis}}
