...
\toprule
Activités & HTML & CSS & Python & Variable & Séquence\tabularnewline
\midrule
\endhead
Act. 1 & /5 & /5 & & &\tabularnewline
Act. 2 & /5 & & & &\tabularnewline
Act. 3 & /5 & /5 & & &\tabularnewline
Act. 4 & & & /5 & &\tabularnewline
Act. 5 & & & /5 & /5 & /5\tabularnewline
Act. 6 & & & & /5 &\tabularnewline
Act. 7 & & & & /5 & /5\tabularnewline
Act. 8 & & & /5 & /5 & /5\tabularnewline
Act. 9 & /5 & & & &\tabularnewline
Act. 10 & & /5 & & &\tabularnewline
Act. 11 & & /5 & & &\tabularnewline
Act. 12 & & /5 & & &\tabularnewline
Act. 13 & /5 & & & &\tabularnewline
Total & & & & &\tabularnewline
\bottomrule
\end{longtable}
\begin{eleve}
    \textbf{Explique} en quelques mots :

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  ce qu'est le HTML et ce qu'est une balise
\item
  ce qu'est le CSS et la différence entre l'attribut \texttt{class} et
  \texttt{id}
\end{enumerate}
        
        \end{eleve}\begin{eleve}
    Il y a trois balises obligatoires dans un fichier HTML. \textbf{Indique}
leur structure.
        
        \end{eleve}\begin{eleve}
    \textbf{Donne} 2 exemples de balises vides, de balises de structure, de
balises de texte et de balises neutres.

\textbf{Donne} 5 exemples de propriétés CSS.
        
        \end{eleve}\begin{eleve}
    En Python, \textbf{indique} et \textbf{décris} deux types de nombres
différents.
...
\end{Shaded}
        ...
        \end{eleve}\begin{eleve}
    \textbf{Écrire} un programme qui demande à l'utilisateur les longueurs
(entières) des deux côtés d'un rectangle et affiche son aire.
        
        \end{eleve}\begin{eleve}
    \textbf{Écrit} le code permettant d'afficher dans un document HTML :

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  en \textbf{gras} le texte \emph{``Ceci est un texte en gras !''} ;
\item
  en \textbf{italique} le texte \emph{``Ceci est un texte en italique
  !''} ;
\item
  un \textbf{lien hypertexte} vers le site \url{www.atrium-sud.fr}
  activable en cliquant sur le texte \emph{``Accéder au site Atrium''} ;
\item
  l'\textbf{image} \texttt{logo\_html.svg} qui est dans le sous
  répertoire \texttt{res} et lui imposer une largeur de 240px.
\end{enumerate}
        
        \end{eleve}\begin{eleve}
    \textbf{Décrit} en quelques mots les 3 méthodes permettant d'appliquer
du code CSS à un fichier HTML.
        
        \end{eleve}\begin{eleve}
    \textbf{Indique} les couleurs associées aux codages hexadécimal
\texttt{\#ffffff} et \texttt{\#000000}.

\textbf{Que représente} la valeur \texttt{ff} en hexadécimal ?
        
        \end{eleve}\begin{eleve}
    \textbf{Indique} comment modifier la couleur du contenu de toutes les
balises \texttt{\textless{}ul\textgreater{}} de classe \texttt{impair}
qui appartiennent aux paragraphes \texttt{\textless{}p\textgreater{}}.
        
        \end{eleve}\begin{eleve}
    Pour chacun des fragments de code ci-dessous dire s'il sont valides.
S'ils ne le sont pas, dire pourquoi. On suppose que ces fragments sont
contenus entre deux balises
...
\begin{Shaded}
\begin{Highlighting}[]
   \KeywordTok{\textless{}i\textgreater{}\textless{}u\textgreater{}}\NormalTok{du texte}\KeywordTok{\textless{}/u\textgreater{}\textless{}/i\textgreater{}}
\end{Highlighting}
\end{Shaded}
\item
\begin{Shaded}
\begin{Highlighting}[]
   \KeywordTok{\textless{}p\textgreater{}\textless{}u\textgreater{}}\NormalTok{du texte}\KeywordTok{\textless{}/i\textgreater{}\textless{}/p\textgreater{}}
\end{Highlighting}
\end{Shaded}
\item
\begin{Shaded}
\begin{Highlighting}[]
   \KeywordTok{\textless{}b}\OtherTok{ class=}\StringTok{"a"}\OtherTok{ class=}\StringTok{"b"}\KeywordTok{\textgreater{}}\NormalTok{en gras}\KeywordTok{\textless{}/b\textgreater{}}
\end{Highlighting}
\end{Shaded}
\item
\begin{Shaded}
\begin{Highlighting}[]
   \KeywordTok{\textless{}head\textgreater{}}
      \KeywordTok{\textless{}b\textgreater{}}\NormalTok{Bonjour}\KeywordTok{\textless{}/b\textgreater{}}
   \KeywordTok{\textless{}/head\textgreater{}}
\end{Highlighting}
\end{Shaded}
\item
\begin{Shaded}
\begin{Highlighting}[]
   \KeywordTok{\textless{}h1}\OtherTok{ id=}\StringTok{"t1"}\KeywordTok{\textgreater{}}\NormalTok{Titre}\KeywordTok{\textless{}/h1\textgreater{}}
   \KeywordTok{\textless{}h1}\OtherTok{ id=}\StringTok{"t1"}\KeywordTok{\textgreater{}}\NormalTok{Titre}\KeywordTok{\textless{}/h1\textgreater{}}
\end{Highlighting}
\end{Shaded}
\end{enumerate}
