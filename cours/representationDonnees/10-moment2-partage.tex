...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/pdf_solution/papier_eleve_ico_machine}\ttfamily\scshape Machines}\fancyhead[C]{\bfseries\MakeUppercase{10-moment2-partage}}\fancyhead[C]{\bfseries\MakeUppercase{Repr. des données - Act. partage}}\fancyhead[R]{\monthyeardate\today}
...
\begin{document}
    ...
    \title{Repr. des données - Act. partage}
% \maketitle
...
\textbf{autonomie}. Chacun de vous doit comprendre \textbf{toutes les
parties} et être capable de faire \textbf{seul} d'autres exercices
d'application.

        \end{formule}
    \hypertarget{encodage-hexaduxe9cimal}{%
\subsection{1. Encodage hexadécimal}\label{encodage-hexaduxe9cimal}}
\begin{eleve}
    \textbf{(Symboles hexadécimaux)} Combien de symbole en hexadécimal ?
lesquels?
        
        \end{eleve}\begin{eleve}
    \textbf{(Puissances de 16)} Quelles sont les puissances de 16 jusqu'à 3?
        
        \end{eleve}\begin{eleve}
    \textbf{(binaire vers hexadécimal)} Traduire en hexadécimal de longueur
4 \(10011010_2\), \(10110110_2\), \(84_{10}\) et \(110011101101101_2\).
        
        \end{eleve}\begin{eleve}
    \textbf{(hexadécimal vers binaire vers décimal)} Traduire en binaire
puis en décimal \(\text{A3}_{16}\), \(\text{4F}_{16}\),
\(\text{100}_{16}\).
        
        \end{eleve}
    \hypertarget{encodage-des-entiers-relatifs}{%
\subsection{2. Encodage des entiers
relatifs}\label{encodage-des-entiers-relatifs}}
\begin{eleve}
    \textbf{(entier relatif)} Qu'est ce qu'un entier relatif?
        
        \end{eleve}\begin{eleve}
    \textbf{(entier relatif vers binaire)} Représenter en binaire sur 1
octet : \(6\) et \(-4\).
        
        \end{eleve}\begin{eleve}
    \textbf{(entier relatif vers binaire)} Représenter en binaire sur 2
octet : \(-60\) et \(-666\).
        
        \end{eleve}\begin{eleve}
    \textbf{(binaire vers entier relatif)} Convertir en écriture décimale
les entiers relatifs codés sur 8 bits suivants : \(100100_2\),
\(11010001_2\) et \(11101010\).
        
        \end{eleve}
    \hypertarget{encodage-de-textes}{%
\subsection{3. Encodage de textes}\label{encodage-de-textes}}

    \includegraphics{img-ascii.png}
\begin{eleve}
    \textbf{(Code ASCII)} Quelle est la représentation en \textbf{décimal}
du caractère \texttt{g} ? en \textbf{binaire} ?

Quelle sont celles de la caractère Q ? Comment représenter le caractère
\texttt{€} ?
        
        \end{eleve}\begin{eleve}
    \textbf{(Point de code)} Point de code ? Tailles possibles ?
        
        \end{eleve}\begin{eleve}
    \textbf{(Méthode UTF-8)} 4 cas possibles pour l'encodage UTF-8?
