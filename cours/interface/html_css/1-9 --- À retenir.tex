...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[C]{\bfseries\MakeUppercase{1-9 --- À retenir}}\fancyhead[R]{\monthyeardate\today}
...
\begin{document}
    ...
    \author{Pascal Padilla}\title{1-9 --- À retenir}
% \maketitle
...
\subsection{1.5 --- À retenir}\label{uxe0-retenir}}

    Le langage \textbf{HTML} est le langage de description des pages Web.
Ces dernières sont des documents structurés par des \textbf{balises}
suivant un ensemble de règles de \textbf{bonne formation}. Après avoir
défini la structure d'une page, on peut définir sa charte graphique au
moyen du langage \textbf{CSS} qui permet d'ajuster finement toutes les
caractéristiques graphique d'une page Web.
