...
% \maketitle
    ...
    \hypertarget{html---activituxe9}{%
\subsection{1.2 --- HTML - Activité}\label{html---activituxe9}}
\begin{eleve}
    \textbf{Consigne}

Par groupe, réaliser (au moins) une page au format HTML retraçant les
grandes étapes du développement du Web.
