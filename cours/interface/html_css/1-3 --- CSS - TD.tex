...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[C]{\bfseries\MakeUppercase{1-3 --- CSS - TD}}\fancyhead[R]{\monthyeardate\today}
    ...
    \author{Pascal Padilla}\title{1-3 --- CSS - TD}
% \maketitle
