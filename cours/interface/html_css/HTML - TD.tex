...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=2cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{ico_interface}\ttfamily\scshape Interfaces}\fancyhead[C]{HTML - TD}\fancyhead[R]{\monthyeardate\today}
