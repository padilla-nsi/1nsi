...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=2cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[R]{\monthyeardate\today}
    ...
    \author{Pascal Padilla}\title{Chapitre 1 - HTML et CSS}
% \maketitle
...
\item
  ...
  \tightlist
  \item
    \href{./HTML\%20-\%20TD.ipynb}{Travaux Dirigés}
  \item
    \href{./HTML\%20-\%20Activité.ipynb}{Activité}
  \end{enumerate}
\item
  CSS
  ...
  \tightlist
  \item
    \href{./CSS\%20-\%20TD.ipynb}{Travaux Dirigés}
  \item
    \href{./CSS\%20-\%20Activité.ipynb}{Activité}
  \end{enumerate}
\item
