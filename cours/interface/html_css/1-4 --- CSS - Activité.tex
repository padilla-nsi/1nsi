...
% \maketitle
    ...
    \hypertarget{css---activituxe9}{%
\subsection{1.4 --- CSS - Activité}\label{css---activituxe9}}
\begin{eleve}
    \textbf{Consigne}

Par groupe, mettre en forme et personnalisé avec \emph{style} votre
travail sur l'histoire du Web produit en HTML.
...
\item
  ...
  \item
    justesse
  \item
    \textbf{clartée} et lisibilité
  \item
    \textbf{productions personnelles}
  \end{itemize}
\item
  Document produit
...
\item
  ...
  \tightlist
  \item
    \textbf{absence de copier/coller}
  \item
