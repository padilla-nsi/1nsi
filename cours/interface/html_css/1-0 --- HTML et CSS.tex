...
\end{itemize}
    ...
    \begin{longtable}[]{@{}lll@{}}
\toprule
Durée & Activité & Ressources\tabularnewline
\midrule
\endhead
1h & Découvrir le HTML &
\href{1-1\%20---\%20HTML\%20-\%20TD-eleve.ipynb}{TD} ;
\href{1-1\%20---\%20HTML\%20-\%20TD.ipynb}{corrigé notebook} ;
\href{1-1\%20---\%20HTML\%20-\%20TD.pdf}{corrigé pdf} ;
\href{1-1\%20---\%20HTML\%20-\%20TD-book.pdf}{corrigé pdf
R/V}\tabularnewline
1h & Activité - Produire un document HTML &
\href{1-2\%20---\%20HTML\%20-\%20Activité.ipynb}{sujet notebook} ;
\href{1-2\%20---\%20HTML\%20-\%20Activit\%C3\%A9.pdf}{sujet
pdf}\tabularnewline
1h & Découvrir le CSS &
\href{1-3\%20---\%20CSS\%20-\%20TD-eleve.ipynb}{TD} ;
\href{1-3\%20---\%20CSS\%20-\%20TD.ipynb}{corrigé notebook} ;
\href{1-3\%20---\%20CSS\%20-\%20TD.pdf}{corrigé pdf} ;
\href{1-3\%20---\%20CSS\%20-\%20TD-book.pdf}{corrigé pdf
R/V}\tabularnewline
1h & Activité - mettre en forme le document produit &
\href{1-4\%20---\%20CSS\%20-\%20Activit\%C3\%A9.ipynb}{sujet} ;
\href{1-4\%20---\%20CSS\%20-\%20Activit\%C3\%A9.pdf}{sujet
pdf}\tabularnewline
& \textbf{synthèse} & \href{./1-9\%20---\%20À\%20retenir.ipynb}{À
retenir}\tabularnewline
\bottomrule
\end{longtable}
