...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[C]{\bfseries\MakeUppercase{1-0 --- HTML et CSS}}\fancyhead[R]{\monthyeardate\today}
    ...
    \author{Pascal Padilla}\title{1-0 --- HTML et CSS}
% \maketitle
...
\item
  ...
  \tightlist
  \item
    Travaux Dirigés : découverte HTML

    \begin{itemize}
    \tightlist
    \item
      Notebook \href{1-1\%20HTML\%20-\%20TD-eleve.ipynb}{élève} et
      \href{1-1\%20HTML\%20-\%20TD.ipynb}{prof}
    \item
      PDF \href{1-1\%20HTML\%20-\%20TD.pdf}{écran} et
      \href{1-1\%20HTML\%20-\%20TD_livre.pdf}{à imprimer}
    \end{itemize}
  \item
    Activité : créer un document HTML sur l'historique du Web

    \begin{itemize}
    \tightlist
    \item
      Notebook \href{1-2\%20HTML\%20-\%20Activité.ipynb}{Activité}
    \item
      PDF \href{1-2\%20HTML\%20-\%20Activit\%C3\%A9.pdf}{écran}
    \end{itemize}
  \end{enumerate}
\item
  CSS
  ...
  \tightlist
  \item
    Travaux Dirigés : découverte et prise en main du CSS

    \begin{itemize}
    \tightlist
    \item
      Notebook \href{CSS\%20-\%20TD-eleve.ipynb}{élève} et
      \href{CSS\%20-\%20TD.ipynb}{prof}
    \item
      PDF \href{CSS\%20-\%20TD.pdf}{écran} et
      \href{CSS\%20-\%20TD_livre.pdf}{à imprimer}
    \end{itemize}
  \item
    Activité : mettre en forme le document Historique du Web

    \begin{itemize}
    \tightlist
    \item
      Notebook \href{CSS\%20-\%20Activit\%C3\%A9.ipynb}{Activité}
    \item
      PDF \href{CSS\%20-\%20Activit\%C3\%A9.pdf}{écran}
    \end{itemize}
  \end{enumerate}
\item
  \href{./Chapitre\%201\%20-\%20À\%20retenir.ipynb}{À retenir}
\end{enumerate}
