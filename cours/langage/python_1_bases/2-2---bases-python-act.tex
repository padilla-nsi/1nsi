...
\texttt{a} et \texttt{b} ont été \textbf{permutées}.
        ...
        \end{reponse}\begin{eleve}
    On met deux entiers dans deux variables \texttt{a} et \texttt{b}, par
exemple 55 et 89. On remplace le contenu de \texttt{a} par la somme de
celui de \texttt{a} et de \texttt{b}. Puis on remplace le contenu de
\texttt{b} par le contenu de \texttt{a} moins le contenu de \texttt{b}?
Enfin on remplace le contenu de \texttt{a} par son contenu moins celui
de \texttt{b}.
...
\begin{eleve}
    \textbf{Écrire} un programme qui demande d'entrer une base (entre 2 et
36) et un nombre dans cette base et qui affiche ce nombre en base 10.
...
\begin{eleve}
    \textbf{Écrire} un programme qui demande à l'utilisateur d'entrer un
nombre de secondes et qui l'affiche sous la forme
